...
from library.getPath import get_screenshot
...
class Register(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        self.screenshotDir = get_screenshot()
        self.driver.implicitly_wait(3)
        self.driver.maximize_window()

    @data(*get_csv_data('canshu.csv'))
    @unpack
    def test_register(self, number,username, passwd, repasswd, email, assert_result):
        driver = self.driver
